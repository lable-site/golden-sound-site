// ============================================================
//  config.js — Golden Sound v5.0 LUXURY 2026
//
//  Supabase-ready luxury template 2026
//
//  ⚙️  ПЕРЕКЛЮЧАТЕЛЬ РЕЖИМА ДАННЫХ:
//     USE_SUPABASE = false → MOCK_DB (работает прямо сейчас)
//     USE_SUPABASE = true  → реальный Supabase
//
//  🔑  ПОДКЛЮЧЕНИЕ SUPABASE:
//     1. Установите USE_SUPABASE = true
//     2. Вставьте SUPABASE_URL  (Project Settings → API → Project URL)
//     3. Вставьте SUPABASE_KEY  (Project Settings → API → anon public)
//     4. Таблицы создаёт SUPABASE_SETUP.sql
// ============================================================

export const USE_SUPABASE = false; // ← ПЕРЕКЛЮЧАТЕЛЬ

export const SUPABASE_URL = 'https://ВАШ_ПРОЕКТ_ID.supabase.co'; // ← ваш URL
export const SUPABASE_KEY = 'ВАШ_ANON_KEY';                       // ← ваш ключ

// ============================================================
//  MOCK_DB — полная имитация базы данных.
//  Структура идентична реальным таблицам Supabase.
//  При USE_SUPABASE=true этот объект игнорируется.
// ============================================================
export const MOCK_DB = {

    // Таблица: artists
    // name=null → placeholder-карточка «+»
    artists: [
    ...
    // Таблица: site_config (ключ → значение)
    site_config: {
...
// Обратная совместимость с artists.js / content.js
